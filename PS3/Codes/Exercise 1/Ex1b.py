...
elapsed = time.time() - t
print("Ex1b runtime:", elapsed)
print("Ex1b no. iterations:", it)

plt.plot(ks,value)
plt.xlabel('Capital')
plt.ylabel('Value')
plt.title('Value function plot 1b')
plt.savefig('Value function plot 1b.png')
plt.show()

plt.plot(ks,np.ones(S))
plt.xlabel('Capital')
plt.ylabel('Labour')
plt.title('Labour policy function plot 1b')
plt.savefig('Labour policy function plot 1b.png')
plt.show()

plt.plot(ks,cons)
plt.xlabel('Capital')
plt.ylabel('Consumption')
plt.title('Consumption policy function plot 1b')
plt.savefig('Consumption policy function plot 1b.png')
plt.show()

plt.plot(ks,kp)
plt.xlabel('Capital')
plt.ylabel('Capital policy function')
plt.title('Capital policy function plot 1b')
plt.savefig('Capital policy function plot 1b.png')
plt.show()