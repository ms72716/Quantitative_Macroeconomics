# -*- coding: utf-8 -*-
"""
Created on Sat Oct 24 01:39:14 2020
...
elapsed = time.time() - t
print("Ex1d runtime:", elapsed)
print("Ex1d no. iterations:", it)

plt.plot(ks,value)
plt.xlabel('Capital')
plt.ylabel('Value')
plt.title('Value function plot 1_d')
plt.savefig('Value function plot 1_d.png')
plt.show()

plt.plot(ks,np.ones(S))
plt.xlabel('Capital')
plt.ylabel('Labour')
plt.title('Labour policy function plot 1d')
plt.savefig('Labour policy function plot 1d.png')
plt.show()

plt.plot(ks,cons)
plt.xlabel('Capital')
plt.ylabel('Consumption')
plt.title('Consumption policy function plot 1d')
plt.savefig('Consumption policy function plot 1d.png')
plt.show()

plt.plot(ks,kp)
plt.xlabel('Capital')
plt.ylabel('Capital policy function')
plt.title('Capital policy function plot 1d')
plt.savefig('Capital policy function plot 1d.png')
plt.show()