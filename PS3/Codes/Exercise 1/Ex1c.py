...
elapsed = time.time() - t
print("Ex1c runtime:", elapsed)
print("Ex1c no. iterations:", it)

plt.plot(ks,value)
plt.xlabel('Capital')
plt.ylabel('Value')
plt.title('Value function plot 1c')
plt.savefig('Value function plot 1c.png')
plt.show()

plt.plot(ks,np.ones(S))
plt.xlabel('Capital')
plt.ylabel('Labour')
plt.title('Labour policy function plot 1c')
plt.savefig('Labour policy function plot 1c.png')
plt.show()

plt.plot(ks,cons)
plt.xlabel('Capital')
plt.ylabel('Consumption')
plt.title('Consumption policy function plot 1c')
plt.savefig('Consumption policy function plot 1c.png')
plt.show()

plt.plot(ks,kp)
plt.xlabel('Capital')
plt.ylabel('Capital policy function')
plt.title('Capital policy function plot 1c')
plt.savefig('Capital policy function plot 1c.png')
plt.show()
