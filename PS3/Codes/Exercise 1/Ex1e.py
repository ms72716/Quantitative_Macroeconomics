# -*- coding: utf-8 -*-
"""
Created on Sat Oct 24 12:48:47 2020
...
elapsed = time.time() - t
print("Ex1e runtime:", elapsed)
print("Ex1e no. iterations:", it)

plt.plot(ks,value)
plt.xlabel('Capital')
plt.ylabel('Value')
plt.title('Value function plot 1e')
plt.savefig('Value function plot 1e.png')
plt.show()

plt.plot(ks,np.ones(S))
plt.xlabel('Capital')
plt.ylabel('Labour')
plt.title('Labour policy function plot 1e')
plt.savefig('Labour policy function plot 1e.png')
plt.show()

plt.plot(ks,cons)
plt.xlabel('Capital')
plt.ylabel('Consumption')
plt.title('Consumption policy function plot 1e')
plt.savefig('Consumption policy function plot 1e.png')
plt.show()

plt.plot(ks,kp)
plt.xlabel('Capital')
plt.ylabel('Capital policy function')
plt.title('Capital policy function plot 1e')
plt.savefig('Capital policy function plot 1e.png')
plt.show()
