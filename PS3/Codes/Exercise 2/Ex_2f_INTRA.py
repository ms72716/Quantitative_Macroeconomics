# -*- coding: utf-8 -*-
"""
Created on Tue Oct 27 21:27:12 2020
...
# Specify the iteration when Howard improvements starts
H_S = 15
...
elapsed = time.time() - t
print("Ex2f runtime:", elapsed)
print("Ex2f no. iterations:", it)

plt.plot(ks,value)
plt.xlabel('Capital')
plt.ylabel('Value')
plt.title('Value function plot 2f_INTRA')
plt.savefig('Value function plot 2f_INTRA.png')
plt.show()

plt.plot(ks,l)
plt.xlabel('Capital')
plt.ylabel('Labour')
plt.title('Labour policy function plot 2f_INTRA')
plt.savefig('Labour policy function plot 2f_INTRA.png')
plt.show()

plt.plot(ks,cons)
plt.xlabel('Capital')
plt.ylabel('Consumption')
plt.title('Consumption policy function plot 2f_INTRA')
plt.savefig('Consumption policy function plot 2f_INTRA.png')
plt.show()

plt.plot(ks,kp)
plt.xlabel('Capital')
plt.ylabel('Capital policy function')
plt.title('Capital policy function plot 2f_INTRA')
plt.savefig('Capital policy function plot 2f_INTRA.png')
plt.show()
