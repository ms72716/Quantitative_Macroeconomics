...
plt.xlabel('Capital')
plt.ylabel('Value')
plt.title('Value function plot 2e_INTRA')
plt.savefig('Value function plot 2e_INTRA.png')
plt.show()

plt.plot(ks,l)
plt.xlabel('Capital')
plt.ylabel('Labour')
plt.title('Labour policy function plot 2e_INTRA')
plt.savefig('Labour policy function plot 2e_INTRA.png')
plt.show()

plt.plot(ks,cons)
plt.xlabel('Capital')
plt.ylabel('Consumption')
plt.title('Consumption policy function plot 2e_INTRA')
plt.savefig('Consumption policy function plot 2e_INTRA.png')
plt.show()

plt.plot(ks,kp)
plt.xlabel('Capital')
plt.ylabel('Capital policy function')
plt.title('Capital policy function plot 2e_INTRA')
plt.savefig('Capital policy function plot 2e_INTRA.png')
plt.show()
